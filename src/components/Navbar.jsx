...
export const Navbar = () => {
  ...
  const activeClass = (path) => {
    ...
    return currentPath === path
      ? "relative bg-gradient-to-r from-blue-700 to-gray-700 text-white shadow-lg transform scale-105 font-bold px-6 py-2 rounded-xl transition-all duration-300"
      : "relative text-gray-300 hover:text-white hover:bg-gray-800/10 hover:scale-105 hover:shadow-lg font-semibold px-6 py-2 rounded-xl transition-all duration-300 backdrop-blur-sm";
  };
          ...
          <div className="flex items-center space-x-2 text-lg">
            ...
            {!user ? (
              <>
                ...
                <Link 
                  to="/register" 
                  className="relative bg-gradient-to-r from-blue-700 to-gray-700 text-white font-bold px-6 py-2 rounded-xl shadow-lg hover:shadow-xl hover:from-blue-800 hover:to-gray-800 transform hover:scale-105 transition-all duration-300 ml-2"
                >
              ...
              <>
                ...
                <div className="relative ml-4" ref={dropdownRef}>
                  <button
                    ...
                    className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm border border-gray-600/20 rounded-xl px-4 py-2 text-white hover:bg-gray-800/20 transition-all duration-300 transform hover:scale-105"
                  >
                    <div className="relative">
                      ...
                      <img
                        ...
                        alt="Profile"
                        className="relative w-8 h-8 rounded-full object-cover border-2 border-blue-600/30"
                  ...
                  {profileOpen && (
                    <div className="absolute right-0 mt-3 w-60 bg-gray-900/95 backdrop-blur-xl border border-gray-600/20 rounded-2xl shadow-2xl text-white z-[9999] overflow-hidden">
                      {/* Header del dropdown */}
                      <div className="bg-gradient-to-r from-blue-600/20 to-gray-600/20 p-4 border-b border-gray-600/20">
                        <div className="flex items-center space-x-3">
                          <div className="relative">
                            ...
                            <img
                              src={profilePhoto || "/default-avatar.png"}
                              alt="Profile"
                              className="relative w-12 h-12 rounded-full object-cover border-2 border-blue-600/30"
                              onError={(e) => { e.target.src = "/default-avatar.png"; }}
                            />
                          </div>
                          <div>
                      ...
                      <div className="py-2">
                        <Link
                          to={`/profile/${user.id}`}
                          className="group flex items-center space-x-3 px-4 py-3 text-sm hover:bg-gray-800/10 transition-all duration-200 border-b border-gray-600/20"
                          onClick={() => setProfileOpen(false)}
                        >
                          <div className="w-8 h-8 bg-gradient-to-r from-blue-600/20 to-gray-600/20 rounded-lg flex items-center justify-center group-hover:from-blue-600/30 group-hover:to-gray-600/30 transition-all duration-200">
