...
export const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white mt-auto">
      {/* Background glow effect */}
      <div className="absolute inset-0 bg-gradient-to-t from-yellow-500/5 via-orange-500/5 to-transparent"></div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            ...
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-3">
                ...
                <div>
                  <p className="text-xl font-bold bg-gradient-to-r from-white to-yellow-200 bg-clip-text text-transparent">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <Link 
                  to="/" 
                  className="group flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-gradient-to-r hover:from-yellow-400/20 hover:to-orange-400/20 hover:border-yellow-400/30 transition-all duration-300 transform hover:scale-105"
                >
            ...
            <div className="text-center lg:text-right">
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="group flex items-center justify-center lg:justify-end gap-3 px-4 py-3 bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-xl hover:bg-green-500/20 hover:border-green-400/40 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 transform hover:scale-105"
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-green-400 text-xs">+56 9 7203 3734</p>
                  </div>
                </a>

                <a
                  href="mailto:raul.rodriguez.c.2012@gmail.com"
                  className="group flex items-center justify-center lg:justify-end gap-3 px-4 py-3 bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-xl hover:bg-blue-500/20 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 transform hover:scale-105"
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-blue-400 text-xs">raul.rodriguez.c.2012@gmail.com</p>
                  </div>
                </a>
              </div>
            </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              <span className="px-3 py-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-full text-xs text-purple-300 font-medium">Unity</span>
              <span className="px-3 py-1 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/30 rounded-full text-xs text-blue-300 font-medium">React</span>
              <span className="px-3 py-1 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-400/30 rounded-full text-xs text-yellow-300 font-medium">Phaser</span>
              <span className="px-3 py-1 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-400/30 rounded-full text-xs text-green-300 font-medium">Node.js</span>
            </div>
